...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = getResources().getColor(R.color.widget_color_primary);
    private final int DEFAULT_COLOR_PRIMARY_DARK = getResources().getColor(R.color.widget_color_primary);
