 ...
 * Description:
 */
open class RecyclerViewDivider(context: Context, orientation: Int) : ItemDecoration() {
     ...
     */
    constructor(context: Context, dividerColor: Int, dividerHeight: Float = 1f, orientation: Int = LinearLayoutManager.VERTICAL) : this(context, orientation) {
        mDividerHeight = dividerHeight.dp
    ...
    private fun drawVertical(canvas: Canvas, parent: RecyclerView) {
        ...
        val right = parent.measuredWidth - parent.paddingRight - paddingRight
    ...
    private fun drawHorizontal(canvas: Canvas, parent: RecyclerView) {
        ...
        for (i in 0 until childSize) {
            val child = parent.getChildAt(i)
            val layoutParams = child.layoutParams as RecyclerView.LayoutParams
            val left = child.right + layoutParams.marginEnd
