 ...
 * Description:
 */
class ForwardBatchMsg(listener: ForwardMessageClickListener) : ForwardText(listener) {
    ...
    override fun setupView(holder: BaseViewHolder, item: ForwardMsg) {
        ...
        holder.setText(R.id.tv_message, context.getString(R.string.core_msg_type8))
    }
}