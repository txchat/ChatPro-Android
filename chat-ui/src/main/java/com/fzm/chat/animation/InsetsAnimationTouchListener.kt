 ...
 * [InsetsAnimationRelativeLayout] which uses the much richer nested scrolling APIs to detect and
 ...
 */
@Deprecated(
    message = "效果不是很好，使用InsetsAnimationLinearLayout作为父布局",
    replaceWith = ReplaceWith("InsetsAnimationLinearLayout")
)
...
class InsetsAnimationTouchListener(
    ...
    private fun View.copyBoundsInWindow(rect: Rect) {
