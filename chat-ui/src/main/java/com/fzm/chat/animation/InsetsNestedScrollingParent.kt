...
class InsetsNestedScrollingParent(private val viewGroup: ViewGroup) : NestedScrollingParent3 {

    private val nestedScrollingParentHelper = NestedScrollingParentHelper(viewGroup)
    ...
    override fun onStartNestedScroll(child: View, target: View, axes: Int): Boolean {
        return viewGroup.onStartNestedScroll(child, target, axes)
    }
    ...
    override fun onNestedPreScroll(target: View, dx: Int, dy: Int, consumed: IntArray, type: Int) {
        ...
        if (deltaY < 0) {
            ...
            if (imeAnimController.isInsetAnimationInProgress()) {
                ...
                viewGroup.rootWindowInsets.isVisible(WindowInsets.Type.ime())
            ) {
    ...
    override fun onNestedFling(
        ...
        if (imeAnimController.isInsetAnimationInProgress()) {
            ...
            // using the velocityY
            val imeVisible = viewGroup.rootWindowInsets.isVisible(WindowInsets.Type.ime())
            when {
                velocityY > 0 && scrollImeOnScreenWhenNotVisible && !imeVisible -> {
                    ...
                    imeAnimController.startAndFling(viewGroup, velocityY)
                    // Indicate that we reacted to the fling
                    return true
                }
    ...
    override fun getNestedScrollAxes(): Int {
        return viewGroup.nestedScrollAxes
    }
    ...
    fun dispatchWindowInsetsAnimationPrepare(animation: WindowInsetsAnimation) {
    ...
    override fun onNestedScroll(
        ...
        viewGroup.onNestedScroll(target, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed)
    }
